  ...
  return (
    <div className="container-fluid">
      ...
      <div className="row">
        ...
        <div className="col-lg-2 text-center">github: <a href="http://www.github.com/drzackyll" target="_blank">@drzackyll</a></div>
      </div>
      <div className="row">
        <div className="col-lg-8 col-lg-offset-2">
          ...
          <div>
            ...
            <a href="http://www.unicef.org" target="_blank"><b>UNICEF</b></a>, New York, NY<br />
            T4D Data Analyst and Software Engineer, January 2020 - present<br />
            + Founding member of <a href="https://superset.unicef.io/" target="_blank">Realtime Data Driven Dashboards (R3D)</a> project<br />
          ...
          <br />
          <div>
            <a href="http://www.episcopalchurch.org" target="_blank"><b>The Episcopal Church</b></a>, New York, NY<br />
          ...
          <br />
          <div>
            <a href="http://www.usip.org" target="_blank"><b>United States Institute of Peace</b></a>, Washington, DC<br />
          ...
          <div>
            ...
            <a href="http://www.flatironschool.com" target="_blank"><b>Flatiron School</b></a> - New York, NY - 2016<br />
            + Full Stack Web Development, Ruby on Rails and JavaScript immersive program<br />
          </div>
          <br />
          <div>
            <a href="http://www.american.edu" target="_blank"><b>American University</b></a> - Washington, DC - 2011<br />
            + Master of Arts: International Peace and Conflict Resolution<br />
          </div>
          <br />
          <div>
            <a href="http://www.macalester.edu" target="_blank"><b>Macalester College</b></a> - St. Paul, MN - 2007<br />
