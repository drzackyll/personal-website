    ...
    <div className="container-fluid">
      ...
      <div className="row">
        ...
        <div className="col-sm-6 col-sm-offset-3">
          <a href="https://superset.unicef.io/" target="_blank"><h4>R3D - HAC RCCE Dashboard</h4></a>
      ...
      <div className="row">
        ...
        <div className="col-sm-6 col-sm-offset-3">
          <a href="https://superset.unicef.io/" target="_blank"><h4>R3D - Workspace Dashboard</h4></a>
