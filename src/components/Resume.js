  ...
  return (
    <div className="container-fluid">
      <div className="row">
        ...
        <div className="col-xs-3 text-center">github: <a href="http://www.github.com/drzackyll">@drzackyll</a></div>
        <div className="col-xs-3 text-center"><a href="http://www.medium.com/drzackyll">medium.com/drzackyll</a></div>
      </div>
